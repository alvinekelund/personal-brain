...
brain push [TEXT] [--brief] [--set-to H]     # iMessage to your own Apple ID handle via Messages.app, never SMS (the morning brief + urgent notices); logged in push.log
